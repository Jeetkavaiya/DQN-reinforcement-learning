    ...
    def render(self, mode='human', plot=False):
        ...
        def plot_image(plot_pos):
            ...
            if plot_agent and \
                ...
                agent = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/agent.png'), zoom=0.28),
            ...
            # Plot for Breeze.
                ...
                breeze = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/breeze.png'), zoom=0.28),
                                        np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Gold.
                ...
                gold = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/gold.png'), zoom=0.28),
                                      np.add(plot_pos, [0.5, 0.5]), frameon=False)
                ax.add_artist(gold)
            ...
            # Plot for Pit.
                ...
                pit = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/pit.png'), zoom=0.28),
                                     np.add(plot_pos, [0.5, 0.5]), frameon=False)
                ax.add_artist(pit)
            ...
            # Plot for Stench.
                ...
                stench = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/stench.png'), zoom=0.28),
                                        np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Wumpus.
                ...
                wumpus = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/wumpus.png'), zoom=0.28),
                                        np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Agent and Breeze.
                ...
                agent_breeze = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/agent_breeze.png'), zoom=0.28),
                                              np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Agent and Pit.
                ...
                agent_pit = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/agent_dead_pit.png'), zoom=0.28),
                                           np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Agent and Stench.
                ...
                agent_stench = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/agent_stench.png'), zoom=0.28),
                                              np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Agent, Breeze and Stench.
                ...
                agent_breeze_stench = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/agent_breeze_stench.png'),
            ...
            # Plot for Agent and Wumpus.
                ...
                agent_wumpus = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/agent_dead_wumpus_alive.png'),
            ...
            # Plot for Breeze and Gold.
                ...
                breeze_gold = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/breeze_gold.png'), zoom=0.28),
                                             np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Breeze and Stench.
                ...
                breeze_stench = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/breeze_stench.png'), zoom=0.28),
                                               np.add(plot_pos, [0.5, 0.5]), frameon=False)
            ...
            # Plot for Breeze, Stench, and Gold.
                ...
                breeze_gold_stench = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/breeze_gold_stench.png'),
                                                                zoom=0.28), np.add(plot_pos, [0.5, 0.5]),
                                                    frameon=False)
            ...
            # Plot for Stench and Gold.
                ...
                stench_gold = AnnotationBbox(OffsetImage(plt.imread('/content/drive/MyDrive/assignment_2_part_1/images/stench_gold.png'), zoom=0.28),
                                             np.add(plot_pos, [0.5, 0.5]), frameon=False)
